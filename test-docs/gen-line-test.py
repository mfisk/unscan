...
def main():
    ...
    # Build canonical map after render would be more robust, but we need map for annotate step —
    # render first with a temp map, then re-build from PDF like gen-specimen does.
    # For now build empty and re-build after render (see below).
    canonical_map = {}
